    ...
    return(
        <div className="flex flex-row justify-between px-5 h-full border-b-1 border-[rgba(44,150,80,0.25)]">
            ...
            <div className="flex flex-row justify-between items-center gap-x-2">
                <button className="mx-5 hidden sm:block">Minhas roupas</button>
                ...
                <button className="h-11/12 aspect-square"><Image src={profile} alt="Perfil" className="h-2/3 w-auto mx-auto"/></button>
            </div>
        </div>
    )
